...
StyledPopup {
    ...
    function getUpcomingTodos() {
        ...
        if (unfinishedTodos.length === 0) {
            return Translation.translate("No pending tasks");
        }
        ...
        if (unfinishedTodos.length > 5) {
            todoText += `\n  ${Translation.translate("... and %1 more").arg(unfinishedTodos.length - 5)}`;
        }
    ...
    ColumnLayout {
        ...
        StyledPopupValueRow {
            icon: "timelapse"
            label: Translation.translate("System uptime:")
        ...
        Column {
            ...
            StyledPopupValueRow {
                icon: "checklist"
                label: Translation.translate("To Do:")
                value: ""
            }
