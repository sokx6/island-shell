...
Rectangle {
    ...
    property var tabs: [
        {
            "type": "calendar",
            "name": Translation.translate("Calendar"),
            "icon": "calendar_month",
            "widget": "calendar/CalendarWidget.qml"
        },
        {
            "type": "todo",
            "name": Translation.translate("To Do"),
            "icon": "done_outline",
            "widget": "todo/TodoWidget.qml"
        },
        {
            "type": "timer",
            "name": Translation.translate("Timer"),
            "icon": "schedule",
    ...
    RowLayout {
        ...
        StyledText {
            ...
            text: Translation.translate("%1   •   %2 tasks").arg(DateTime.collapsedCalendarFormat).arg(remainingTasks)
