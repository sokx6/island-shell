...
Item {
    id: root
    property var tabButtonList: [{"icon": "checklist", "name": Translation.translate("Unfinished")}, {"name": Translation.translate("Done"), "icon": "check_circle"}]
    ...
    ColumnLayout {
        ...
        SwipeView {
            ...
            TaskList {
                ...
                emptyPlaceholderText: Translation.translate("Nothing here!")
                taskList: Todo.list
            ...
            TaskList {
                ...
                emptyPlaceholderText: Translation.translate("Finished tasks will go here")
                taskList: Todo.list
                    .map(function(item, i) { return Object.assign({}, item, {originalIndex: i}); })
                    .filter(function(item) { return item.done; })
            }
        ...
        Rectangle { // The dialog
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    text: Translation.translate("Add task")
                }
                ...
                TextField {
                    ...
                    placeholderText: Translation.translate("Task description")
                ...
                RowLayout {
                    ...
                    DialogButton {
                        buttonText: Translation.translate("Add")
