        ...
        RowLayout {
            ...
            RippleButton {
                ...
                contentItem: StyledText {
                    ...
                    text: TimerService.stopwatchRunning ? Translation.translate("Pause") : TimerService.stopwatchTime === 0 ? Translation.translate("Start") : Translation.translate("Resume")
                }
            }
            ...
            RippleButton {
                ...
                contentItem: StyledText {
                    horizontalAlignment: Text.AlignHCenter
                    text: TimerService.stopwatchRunning ? Translation.translate("Lap") : Translation.translate("Reset")
