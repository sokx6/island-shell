    ...
    ColumnLayout {
        ...
        CircularProgress {
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.alignment: Qt.AlignHCenter
                    text: TimerService.pomodoroLongBreak ? Translation.translate("Long break") : TimerService.pomodoroBreak ? Translation.translate("Break") : Translation.translate("Focus")
        ...
        RowLayout {
            ...
            RippleButton {
                contentItem: StyledText {
                    ...
                    text: TimerService.pomodoroRunning ? Translation.translate("Pause") : (TimerService.pomodoroSecondsLeft === TimerService.focusTime) ? Translation.translate("Start") : Translation.translate("Resume")
            ...
            RippleButton {
                ...
                contentItem: StyledText {
                    anchors.centerIn: parent
                    horizontalAlignment: Text.AlignHCenter
                    text: Translation.translate("Reset")
