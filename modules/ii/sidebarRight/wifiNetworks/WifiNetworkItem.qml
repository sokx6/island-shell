    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            StyledText {
                ...
                text: root.wifiNetwork?.ssid ?? Translation.translate("Unknown")
        ...
        ColumnLayout { // Password
            ...
            MaterialTextField {
                id: passwordField
                Layout.fillWidth: true
                placeholderText: Translation.translate("Password")
            ...
            RowLayout {
                ...
                DialogButton {
                    buttonText: Translation.translate("Connect")
                    onClicked: {
                        Network.changePassword(root.wifiNetwork, passwordField.text);
                    }
                }
        ...
        ColumnLayout { // Public wifi login page
            ...
            RowLayout {
                DialogButton {
                    Layout.fillWidth: true
                    buttonText: Translation.translate("Open network portal")
