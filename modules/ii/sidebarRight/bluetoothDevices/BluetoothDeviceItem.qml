    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    text: root.device?.name || Translation.translate("Unknown device")
                ...
                StyledText {
                    ...
                    text: {
                        ...
                        let statusText = root.device?.connected ? Translation.translate("Connected") : Translation.translate("Paired");
        ...
        RowLayout {
            ...
            ActionButton {
                ...
                buttonText: p ? Translation.translate("Forget") : Translation.translate("Always connect")
                onClicked: {
            ...
            ActionButton {
                buttonText: root.device?.connected ? Translation.translate("Disconnect") : Translation.translate("Connect")
