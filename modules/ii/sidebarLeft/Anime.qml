...
Item {
    ...
    property var allCommands: [
        {
            name: "mode",
            description: Translation.translate("Set the current API provider"),
            execute: (args) => {
        ...
        {
            name: "clear",
            description: Translation.translate("Clear the current list of images"),
            execute: () => {
        ...
        {
            name: "next",
            description: Translation.translate("Get the next page of results"),
            execute: () => {
        ...
        {
            name: "safe",
            description: Translation.translate("Disable NSFW content"),
            execute: () => {
        ...
        {
            name: "lewd",
            description: Translation.translate("Allow NSFW content"),
            execute: () => {
    ...
    function handleInput(inputText) {
        if (inputText.startsWith(root.commandPrefix)) {
            ...
            if (commandObj) {
                ...
                Booru.addSystemMessage(Translation.translate("Unknown command: ") + command);
            }
        }
    ...
    ColumnLayout {
        ...
        Item {
            ...
            PagePlaceholder {
                ...
                icon: "bookmark_heart"
                title: Translation.translate("Anime boorus")
                description: ""
        ...
        Rectangle { // Tag input area
            ...
            RowLayout { // Input field and send button
                ...
                StyledTextArea { // The actual TextArea
                    ...
                    placeholderText: Translation.translate('Enter tags, or "%1" for commands').arg(root.commandPrefix)
            ...
            RowLayout { // Controls
                ...
                ApiInputBoxIndicator { // Tool indicator
                    ...
                    tooltipText: Translation.translate("Current API endpoint: %1\nSet it with %2mode PROVIDER")
                ...
                MouseArea { // NSFW toggle
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            text: Translation.translate("Allow NSFW")
                        }
                        StyledSwitch {
                            id: nsfwSwitch
