                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        MenuButton {
                            ...
                            buttonText: Translation.translate("Open file link")
                            onClicked: {
                        ...
                        MenuButton {
                            ...
                            Layout.fillWidth: true
                            buttonText: Translation.translate("Go to source (%1)").arg(StringUtils.getDomain(root.imageData.source))
                        ...
                        MenuButton {
                            id: downloadButton
                            Layout.fillWidth: true
                            buttonText: Translation.translate("Download")
                            onClicked: {
                                root.showActions = false;
                                ...
                                Quickshell.execDetached(["bash", "-c", 
                                    `mkdir -p '${targetPath}' && curl '${StringUtils.shellSingleQuoteEscape(root.imageData.file_url)}'${userAgentHeader} -o '${targetPath}/${root.fileName}' && notify-send '${Translation.translate("Download complete")}' '${root.downloadPath}/${root.fileName}' -a 'Shell'`
                                ])
                            }
                        }
                    }
