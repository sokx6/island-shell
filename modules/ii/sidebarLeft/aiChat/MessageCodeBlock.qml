        ...
        RowLayout { // Language and buttons
            ...
            ButtonGroup {
                AiMessageControlButton {
                    ...
                    StyledToolTip {
                        text: Translation.translate("Copy code")
                    }
                }
                AiMessageControlButton {
                    id: saveCodeButton
                    ...
                    onClicked: {
                        ...
                        Quickshell.execDetached(["notify-send", 
                            Translation.translate("Code saved to file"), 
                            Translation.translate("Saved to %1").arg(`${downloadPath}/code.${segmentLang || "txt"}`),
                            "-a", "Shell"
                        ])
                    ...
                    StyledToolTip {
                        text: Translation.translate("Save to Downloads")
                    }
                }
            }
        }
                        ...
                        ButtonGroup {
                            GroupButton {
                                contentItem: StyledText {
                                    text: Translation.translate("Reject")
                                    font.pixelSize: Appearance.font.pixelSize.small
                                    color: Appearance.colors.colOnLayer2
                                }
                            ...
                            GroupButton {
                                toggled: true
                                contentItem: StyledText {
                                    text: Translation.translate("Approve")
                                    font.pixelSize: Appearance.font.pixelSize.small
