        ...
        Rectangle {
            ...
            RowLayout { // Header
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            text: messageData?.role == 'assistant' ? Ai.models[messageData?.model].name :
                                ...
                                Translation.translate("Interface")
                        }
                    }
                }
                ...
                Button { // Not visible to model
                    ...
                    StyledToolTip {
                        text: Translation.translate("Not visible to model")
                    }
                }
                ...
                ButtonGroup {
                    ...
                    AiMessageControlButton {
                        ...
                        StyledToolTip {
                            text: Translation.translate("Regenerate")
                        }
                    }
                    ...
                    AiMessageControlButton {
                        ...
                        StyledToolTip {
                            text: Translation.translate("Copy")
                        }
                    }
                    AiMessageControlButton {
                        id: editButton
                        ...
                        StyledToolTip {
                            text: root.editing ? Translation.translate("Save") : Translation.translate("Edit")
                        }
                    }
                    AiMessageControlButton {
                        ...
                        StyledToolTip {
                            text: Translation.translate("View Markdown source")
                        }
                    }
                    AiMessageControlButton {
                        id: deleteButton
