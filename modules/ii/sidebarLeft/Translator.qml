...
Item {
    ...
    ColumnLayout {
        ...
        StyledFlickable {
            ...
            ColumnLayout {
                ...
                TextCanvas { // Content translation
                    id: outputCanvas
                    isInput: false
                    placeholderText: Translation.translate("Translation goes here...")
        ...
        TextCanvas { // Content input
            id: inputCanvas
            isInput: true
            placeholderText: Translation.translate("Enter text to translate...")
            onInputTextChanged: {
    ...
    Loader {
        ...
        sourceComponent: SelectionDialog {
            ...
            titleText: Translation.translate("Select Language")
