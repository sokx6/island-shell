...
Singleton {
    ...
    property var properties: {
        ...
        "explanation": Translation.translate("For storing API keys and other sensitive information"),
    }
    ...
    property string keyringLabel: Translation.translate("%1 Safe Storage").arg("illogical-impulse")
