...
Singleton {
    ...
    property string failMessage: Translation.translate("That didn't work. Tips:\n- Check your tags and NSFW settings\n- If you don't have a tag in mind, type a page number")
    ...
    property var providers: {
        "system": { "name": Translation.translate("System") },
        "yandere": {
            "name": "yande.re",
            "url": "https://yande.re",
            "api": "https://yande.re/post.json",
            "description": Translation.translate("All-rounder | Good quality, decent quantity"),
            "mapFunc": (response) => {
        ...
        "konachan": {
            ...
            "description": Translation.translate("For desktop wallpapers | Good quality"),
            "mapFunc": (response) => {
                return response.map(item => {
                    return {
                        "id": item.id,
        ...
        "zerochan": {
            ...
            "description": Translation.translate("Clean stuff | Excellent quality, no NSFW"),
            "mapFunc": (response) => {
        ...
        "danbooru": {
            ...
            "description": Translation.translate("The popular one | Best quantity, but quality can vary wildly"),
            "mapFunc": (response) => {
                return response.map(item => {
                    return {
                        "id": item.id,
        ...
        "gelbooru": {
            ...
            "description": Translation.translate("The hentai one | Great quantity, a lot of NSFW, quality varies wildly"),
            "mapFunc": (response) => {
        ...
        "waifu.im": {
            ...
            "description": Translation.translate("Waifus only | Excellent quality, limited quantity"),
            "mapFunc": (response) => {
                response = response.items
                return response.map(item => {
                    return {
        ...
        "t.alcy.cc": {
            ...
            "url": "https://t.alcy.cc",
            "api": "https://t.alcy.cc/",
            "description": Translation.translate("Large images | God tier quality, no NSFW."),
            "fixedTags": [
                {
                    "name": "ycy",
                    "count": "General"
    ...
    function setProvider(provider) {
        ...
        if (providerList.indexOf(provider) !== -1) {
            ...
            root.addSystemMessage(Translation.translate("Provider set to ") + providers[provider].name
                + (provider == "zerochan" ? Translation.translate(". Notes for Zerochan:\n- You must enter a color\n- Set your zerochan username in `sidebar.booru.zerochan.username` config option. You [might be banned for not doing so](https://www.zerochan.net/api#:~:text=The%20request%20may%20still%20be%20completed%20successfully%20without%20this%20custom%20header%2C%20but%20your%20project%20may%20be%20banned%20for%20being%20anonymous.)!") : ""))
        } else {
            root.addSystemMessage(Translation.translate("Invalid API provider. Supported: \n- ") + providerList.join("\n- "))
        }
    }
